lang_fre = {		
	...
	'newVersionDialog' : 'Une nouvelle version de GCTour est diponible.\nVoulez-vous mettre à jour? \n\n',
	...
	'makeMapWait' : 'Test de la disponibilité de la carte',
	...
	'settings_map_geocacheindex' : 'Afficher le sommaire des cacheses',
	...
	'tourUploaded1' : 'Le Tour a été correctement soumis!\nWebcode:\n      ',
	...
	'settingsShowSpoilerDesc' : 'Les images Spoiler seront imprimables.',
	...
	'settingsLoggedVisitsDesc' : 'Affiche un récapitulatifs des "Trouvé(s)".',
	'settingsPageBreakDesc' : 'Il y aura un saut de page après chaque cache. Visible à l\'impression.',
	'settingsPageBreakAfterMapDesc' : 'Il y aura un saut de page après la vue globale pour la séparer les pages de caches',
	...
	'settingsGPXHtmlDesc' : 'Certains programmes/GPSr ont des problèmes pour afficher les description au format HTML. Si vous ne voyez qu\'une description tronquée de la cache, veuillez SVP désactiver cette option.',
	...
	'settings_map_awptsDesc' : 'Si cette option est cochées les Waypoints seront affichés sur la carte.',
	...
	'settings_map_owptsDesc' : 'Les Waypoints peronnels seront visibles sur la carte.',
	...
	"markerContent" : "Contenu",
	"markerType" : "Type",
	"markerContentHint" : "sera visble dans la version imprimable",
	"markerCaption" : "Légende",
	"autoTour" : "autoTour",
	"autoTourWait" : "Veuillez patienter - autoTour en cours calcul!",
	...
	'updateDialog' : "<div><img src='http://gctour.madd.in/images/antenna.gif' style='float:right'><p>Une nouvelle version de&nbsp;&nbsp;&nbsp;<a target='_blank' href='http://gctour.madd.in'><b>GCTour</b></a>&nbsp;&nbsp;&nbsp;est disponible.</p><p>Version installée : <b>###VERSION_OLD###</b>. Version la plus récentedisponible: <b>###VERSION_NEW###</b></p><p><b>Historique des versions:</b></p><div class='dialogHistory'>###VERSION_HISTORY###</div><div class='dialogFooter'></div>"
	};
